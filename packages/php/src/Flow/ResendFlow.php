 ...
 */
/**
 * Every Resend node executor — the PHP twin of `RESEND_RUNNABLE_KINDS` in
 * @particle-academy/resend-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `ResendFlow::register($kinds, $executors)` — one call, no directory scan.
